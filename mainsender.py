...
with open("C:/Users/HP/Music/Python Projects/Bulk_Email_sender-master/Bulk_Email_sender-master/user.csv") as f:
    data = [row for row in csv.reader(f)]

# file_list = ['emails/message' + str(i) + '.txt' for i in range(1,11)] # Multipale Files
file_list = ['emails/message1.txt'] #Singale Email

with open('C:/Users/HP/Music/Python Projects/Bulk_Email_sender-master/Bulk_Email_sender-master/mails.csv', 'r') as csvfile:
